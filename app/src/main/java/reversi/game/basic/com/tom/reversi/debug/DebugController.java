...
/**
 * Controller before making changes to determine victory/no more moves/etc.
 */
public class DebugController implements IReversiController
{
    ...
    public DebugController(IReversiModel model)
    {
        this.MODEL = model;
//        model.cleanBoard();
        setStartingTiles();
